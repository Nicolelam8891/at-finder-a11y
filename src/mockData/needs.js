const needs = {
  ...
  "Low Vision": {
      "category": "Low Vision",
      "technology parameter": ["magnification software", "browser tools", "cctv", "magnifying device"],
      "disability parameter": "have low vision"
  },
  "Deaf / Hard of Hearing": {
      "category": "Deaf / Hard of Hearing",
      "technology parameter": ["hearing", "telecommunication", "sign language", "alert devices"],
  ...
  "Mobility Supports for Gross Motor Issues": {
      ...
      "technology parameter": ["mobility aids", "home access", "environmental control", "communication aids", "computer access", "daily living aids", "vehicle modifications", "recreation", "leisure", "personal safety", "emergency response"],
  ...
  "Cognitive Supports for Focus": {
      ...
      "technology parameter": ["noise-cancelling headphones", "background music", "time management", "white noise", "brain training", "note taking", "calendar"],
